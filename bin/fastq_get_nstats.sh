...
parser.add_argument('-o', '--outfile', required=False, 
                    help='output fastq file .. suffix ".nstats" added to input filename if not provided')
...
seqtk size $INFASTQ | awk -v f=$INFASTQ -v OFS="\t" '{print $1,$2,$2/$1,f}' | tee $OUTFILE
